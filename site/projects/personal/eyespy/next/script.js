    ...
    const items = [
      { name: "water bottle", img: "img/waterbottle.png", target: true, x: 90, y: 90 },
      { name: "blueberries", img: "img/blueberries.png", target: true, x: 320, y: 140 },
      { name: "basket", img: "img/basket.png", target: false, x: 600, y: 160 },
      { name: "sandwich", img: "img/sandwich.png", target: true, x: 200, y: 320 },
      { name: "tea", img: "img/tea.png", target: false, x: 610, y: 400 }
    ];
