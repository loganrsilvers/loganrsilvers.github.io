    ...
    const items = [
      { name: "plastic bag", img: "img/bag.png", target: true, x: 120, y: 140 },
      { name: "crumpled receipt", img: "img/receipt.png", target: true, x: 320, y: 220 },
      { name: "crumpled tissue", img: "img/paper.png", target: false, x: 520, y: 160 },
      { name: "coca-cola can", img: "img/coke.png", target: false, x: 690, y: 320 },
      { name: "coffee cup", img: "img/cup.png", target: true, x: 240, y: 380 },
      { name: "pidgeon", img: "img/birb.png", target: false, x: 610, y: 430 }
    ];
    ...
    function endGame(win) {
      ...
      nextBtn.textContent = win ? "Play Again" : "Try Again";
    }
